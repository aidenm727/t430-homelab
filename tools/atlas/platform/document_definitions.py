...
DOCUMENT_DEFINITIONS = {
    ...
    "docs/reviews/repository-identity-r1-evidence-2026-08-02.md": DocumentDefinition(
        ...
        purpose="Preserves the Tier 3 R1 boundary, privacy and public-surface work, first-publication and verified-rename chronology, post-rename identity finalization, lifecycle correction, verification and review, owner acceptance, and final R1 publication evidence.",
        canonical=False,
        generated=False,
        capability="Engineering and Evolution",
        status="active",
    ...
    "docs/reviews/eo-2026-013-b1b1-authorization-review-2026-07-16.md": DocumentDefinition(
        path="docs/reviews/eo-2026-013-b1b1-authorization-review-2026-07-16.md",
        purpose="Preserves the accepted split of EO-2026-013 Checkpoint B1b into B1b1 and B1b2, including the exact Deterministic Selector Primitives authorization and continued withholding of selection reasoning and package compilation.",
        canonical=False,
        generated=False,
        capability="Engineering",
        status="accepted",
